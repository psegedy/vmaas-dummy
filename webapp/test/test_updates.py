...
class TestHotCache(WebappTestCase):
    """Test HotCache class."""
...
class TestUpdatesAPI(WebappTestCase):
    ...
    def test_schema_v1(self):
        ...
        schemas.updates_top_all_schema.validate(updates)
        schemas.updates_package_schema.validate(updates["update_list"][PKG])
    ...
    def test_schema_v2(self):
        ...
        schemas.updates_top_all_schema.validate(updates)
        schemas.updates_package_schema_v2.validate(updates["update_list"][PKG])
    ...
    def test_schema_repolist(self):
        ...
        schemas.updates_top_repolist_schema.validate(updates)
    ...
    def test_schema_releasever(self):
        ...
        schemas.updates_top_releasever_schema.validate(updates)
    ...
    def test_schema_basearch(self):
        ...
        schemas.updates_top_basearch_schema.validate(updates)
    ...
    def test_process_empty_pkg_list_v1(self):
        ...
        self.assertEqual(updates, EMPTY_RESPONSE)
    ...
    def test_process_non_exist_v1(self):
        ...
        self.assertEqual(updates, NON_EXIST_RESPONSE)
